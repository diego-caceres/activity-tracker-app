        ...
        <div className="p-4 space-y-3">
            ...
            <div className="relative">
                <textarea
                    ...
                    className="w-full p-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 min-h-[120px] resize-y shadow-sm text-gray-900 placeholder-gray-400"
                />
                {isSavingNote && (
